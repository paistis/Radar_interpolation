...
{
  CImg< unsigned int > I1(src1.c_str());
  CImg< unsigned int > I2(src2.c_str());
  const int W = I1.dimx();
  const int H = I1.dimy();
  CImg< unsigned int > I1_smoothed;
  CImg< unsigned int > I2_smoothed;
  CImg< unsigned int > motionImageF(W, H, 1, 3);
  CImg< unsigned int > motionImageB;
  CImg< double > VF, VB;
  ...
  {
    motionImageB = CImg< unsigned int >(W, H, 1, 3);
                                                     ...
                                                     const string &outFilePrefix)
{
  ...
  CImg< unsigned int > I1_smoothed;
  CImg< unsigned int > I2_smoothed;
  CImg< unsigned int > motionImage(W, H, 1, 3);
  SparseVectorField V;
...
void MotionExtractorDriver::preProcess_(const CImg< unsigned int > &I1,
                                        const CImg< unsigned int > &I2,
                                        CImg< unsigned int > &I1_smoothed,
                                        CImg< unsigned int > &I2_smoothed,
                                        CImg< unsigned int > &motionImageF,
                                        CImg< unsigned int > *motionImageB)
{
...
void MotionExtractorDriver::saveResultImages_(const string &srcFileName1,
                                              ...
                                              const string &outFilePrefix,
                                              const CImg< unsigned int > &I1_smoothed,
                                              const CImg< unsigned int > &I2_smoothed,
                                              const CImg< unsigned int > &motionImageF,
                                              const CImg< unsigned int > *motionImageB)
{
