%picture 1 information and reading
    van_file = 'KUM_Z2_sweep1.tiff';
    kum_file = 'KER_Z2_sweep1.tiff';
    ...
    %find same index's
    %firs some rounding
    lat1_round = floor(lat1*10000)/10000;
    lat2_round = floor(lat2*10000)/10000;
    lon1_round = floor(lon1*10000)/10000;
    lon2_round = floor(lon2*10000)/10000;
    %find intersect
    ...
    corr_coef = corr2(pic1_new,pic2_new);
